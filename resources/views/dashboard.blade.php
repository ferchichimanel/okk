                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="modal-nhlTitle">Pie Chart</h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                              </button>
                            </div>
                            <div class="modal-body">
                            un pie chart qui présente les pourcentages de mesures du taux de glycémie par rapport au taux de glycémie normale « N », l’hypoglycémie « L » et l’hyperglycémie « H ».
                            </div>
        ...
        <div class="card-header ">
            ...
            <div class="modal fade" id="modal-chord" tabindex="-1" role="dialog" aria-labelledby="modal-chordTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-chordTitle">Chord Diagram</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                        le diagramme chord qui permet de corréler les paramètres endogènes (taux de glycémie,..) et les paramètres exogènes (température ambiante, l’emplacement des patients diabétiques) dont le but est d'identifier les nouveaux facteurs du diabète
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div border="1"  id="legende" class="form-group" style="margin-left: 100px;">
                <TABLE border="0" >
                    <TR>
                        ...
                        <TD class=" col-lg-3 text-center"><FONT COLOR="#6D7373">Temperature</FONT></TD>
                        <TD  class="col-lg-1 " bgcolor=#08088A></TD>
                        <TD  class="col-lg-1 text-center"><FONT COLOR="#6D7373">Taux de glycemie</FONT></TD>
        ...
        <div class="card-header ">
            ...
            <div class="modal fade" id="modal-voronoi" tabindex="-1" role="dialog" aria-labelledby="modal-voronoiTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="modal-voronoiTitle">Voronoi Diagram</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
